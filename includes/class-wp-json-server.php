...
class WP_JSON_Server implements WP_JSON_ResponseHandler{
	...
	public function check_authentication() {
		...
		$check_authentication = new MP_REST_Authentication();
		if( ! $check_authentication->authenticate(get_current_user_ID())){
			return new WP_Error( 'json_unauthorized_access', __( 'Unauthorized Access.' ), array( 'status' => 401 ) );
		}
